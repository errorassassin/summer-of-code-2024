...
const RegisterPage = () => {
  ...
  return (
    <div className='gradient-background flex justify-center items-center'>
      <div className="login-hero bg-white flex flex-row-reverse w-[63rem] min-w-[27rem] h-[34rem] rounded-[3rem] p-[2.1rem] gap-[2.1rem] shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px] m-2 scale-[0.75] sm:!scale-[1]">
        ...
        <div className="login-main w-full flex flex-col items-center">
          ...
          <form action="" className='flex flex-col gap-3 mt-auto mb-2' autoComplete='off'>
            ...
            <div className="flex bg-[#F2F2F2] gap-2.5 py-2.5 px-3 rounded-xl w-[20rem]">
              ...
              <input type="name" name="name" id="name-input" className='bg-[#F2F2F2] outline-none w-full text-[15px]' placeholder='Name'></input>
            </div>
            <div className="flex bg-[#F2F2F2] gap-2.5 py-2.5 px-3 rounded-xl w-[20rem]">
              ...
              <input type="email" name="email" id="email-input" className='bg-[#F2F2F2] outline-none w-full text-[15px]' placeholder='Email'></input>
            </div>
            <div className="flex bg-[#F2F2F2] gap-2.5 py-2.5 px-3 rounded-xl w-[20rem]">
              ...
              <input type="password" name="password" id="password-input" className='bg-[#F2F2F2] outline-none w-full text-[15px]' placeholder='Password'></input>
            </div>
